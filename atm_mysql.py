...
class StartPage(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        self.controller.title('Horizon Banking System')
        self.controller.state('zoomed')
        self.controller.iconphoto(False,tk.PhotoImage(file='abc.png'))

        heading=tk.Label(self,text='Horizon Banking System',font=('orbitron',45,'bold'),foreground='white',background='#3d3d5c')
        heading.pack(pady=25)

        space_label=tk.Label(self,height=4,bg='#3d3d5c').pack()

        password_label=tk.Label(self,text=(f'Welcome {user_display_name} to Horizon Banking System'),font=('BatmanForeverAlternate',17),bg='#3d3d5c',fg='white').pack(pady=10)
        ...
        credits=tk.Label(bottom_frame,text='Created and Developed by Sidharth Prabhu',font=('orbitron',15)).pack()
...
class MenuPage(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        heading=tk.Label(self,text='Horizon bank ATM',font=('orbitron',45,'bold'),foreground='white',background='#3d3d5c')
        heading.pack(pady=25)
...
class WithdrawPage(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        heading=tk.Label(self,text='Horiozon bank ATM',font=('orbitron',45,'bold'),foreground='white',background='#3d3d5c')
        heading.pack(pady=25)
        ...
        def withdraw(amount):
            ...
            if amount>current_balance:
                ...
                mycursor.execute("use ATM_MANAGER")
...
class InfoPage(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        mydb=mysql.connector.connect(host="localhost",user="root",password="PASSWORD")
        mycursor=mydb.cursor()
        mycursor.execute("create database if not exists ATM_MANAGER")
        mycursor.execute("use ATM_MANAGER")
...
def main_screen():
  ...
  screen.title("Horizon Banking System")
  screen.configure(bg='lightblue')
  screen.iconphoto(False,tk.PhotoImage(file='abc.png'))


  Label(text = "Horizon Customer Portal",fg='white', bg = "grey", width = "300", height = "2", font = ("orbitron", 15,'bold')).pack()
